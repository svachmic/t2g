...
//
//  Created by Michal Švácha on 23/04/15.
...
/**
Enum used throughout the whole framework for constants. Bizarre numbers are picked so they don't collide with each other.
